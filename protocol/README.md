...
The packet names a portable work kind and compute class, never a provider model. The harness-local
mapping conforms to `schemas/model-routing.schema.json`; an allowed decision emits a deterministic
