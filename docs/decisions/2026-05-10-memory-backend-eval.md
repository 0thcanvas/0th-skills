...
- Markdown remains the authoritative storage format for now, but agents should interact with it through workflow commands and compact briefs instead of manual vault browsing.
