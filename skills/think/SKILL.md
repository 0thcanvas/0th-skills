...
- Codex dispatch fallback: if `0th_explorer` is not exposed as a `spawn_agent` `agent_type`, follow `../../references/codex-dispatch-fallback.md` instead of continuing in the main thread.
